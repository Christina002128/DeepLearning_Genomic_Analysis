# use linear model to test the dataset HA1
library(dplyr)
...
names(coverage_result)<-c("cover_intercept","cover_beta10","cover_beta100","cover_beta200")

# create result table
result<-cbind(intercepts,coefficients,correlations)
colnames(result)<-c("intercept","beta10","beta100","beta200",
